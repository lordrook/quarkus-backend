...
public class Post extends PanacheMongoEntity {
    ...
    public String getTitle() {
        return this.title; //new StringBuilder(title).toString(); // Should be: return title;
    }

    public String getContent() {
        return this.content; //new StringBuilder(content).reverse().toString(); // Should be: return content;
    }
